...
class LoginPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.login_background = PhotoImage(file=f"login_background.png")
        background = login_canvas.create_image(395.0, 300.0, image=self.login_background)
        ...
        textbox_one = login_canvas.create_image(738.5, 263.0, image=self.login_textbox_one)
        ...
        textbox_two = login_canvas.create_image(738.5, 368.0, image=self.login_textbox_two)
...
class Enrollment(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        enrollment_text_background = enrollment_canvas.create_image(722.5, 177.0, image=self.enrollment_text_box)
        ...
        enrollment_text_background_2 = enrollment_canvas.create_image(722.5, 293.0, image=self.enrollment_text_box_2)
        ...
        enrollment_text_background_3 = enrollment_canvas.create_image(722.5, 408.0, image=self.enrollment_text_box_3)
